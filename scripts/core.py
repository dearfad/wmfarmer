...
def get_warframe_price():
    ...
    warframe_prime_list = ['ash', 'atlas', 'banshee', 'chroma', 'ember', 'equinox', 'frost', 'gara', 'garuda', 'harrow', 'hydroid', 'inaros', 'ivara', 'khora', 'limbo', 'loki', 'mag',
                            'mesa', 'mirage', 'nekros', 'nezha', 'nidus', 'nova', 'nyx', 'oberon', 'octavia', 'rhino', 'revenant', 'saryn', 'titania', 'trinity', 'valkyr', 'vauban', 'volt', 'wukong', 'zephyr']
...
def get_weapon_price():
    ...
    weapon_prime_list = ['burston','tenora','braton','sybaris','latron','stradavar','soma','tiberon','baza','boltor','strun','tigris','astilla','corinth','boar','vectis','rubico','panthera']
    ...
    weapon_price_df.insert(loc=0, column='item_name', value='')
    ...
    for i, weapon in enumerate(weapon_prime_list):
        ...
        item_info = get_item_info(weapon + '_prime_set')
