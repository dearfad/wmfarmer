...
def fmt_item_orders(orders_df):
    ...
    orders_dict['ingame_highest_buy_platinum'] = ingame_orders.loc[0,'platinum'].values
    orders_dict['ingame_hightest_buyer'] = ingame_orders.loc[0,'user.ingame_name'].values
